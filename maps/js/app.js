...
var mapboxTiles = {
    accessToken: "pk.eyJ1IjoieWk5MDQ4MzUxMTYiLCJhIjoiY2l2bXB1cjJvMDAwMDJ5cWJlbGs4ams0byJ9.EEdiL2NDeIzvJmmyQclIeg",
...
fetch(seattle911API)
    ...
    .then(function(data){
        ...
        data.forEach(function(record){
            ...
            ,{fillColor: "F00", color: "#F00", fillOpacity:0.5}).addTo(map);
            var html = "<p>" + record.datetime + "</p>" + "<p>" + record.type + "</p>";
